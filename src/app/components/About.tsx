      ...
      <div className="md:container md:mx-auto mt-32 flex max-w-6xl flex-row">
        <div>
          ...
          <p className="mb-4 text-lg">
            My first contact with programming was in early 2020 with the
            development of digital games in the Java language. In fact, I did
            not like it very much, so at the end of 2020 and beginning of 2021 I
            went to full-stack web development in PHP where I had contact with
            HTML, CSS, Javascript, databases and of course, PHP.
          </p>
          <p className="mb-4 text-lg">
          ...
          <p className="mb-4 text-lg">
            Currently, my main point is the front end because I identified with
            it more and soon I intend to migrate to the back end becoming a
            full-stack programmer. I believe that a programmer has to have both
